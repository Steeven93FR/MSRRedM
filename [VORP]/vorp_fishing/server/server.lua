...
RegisterServerEvent('vorp_fishing:discord', function(fishModel, fishWeight, status)
    ...
    local webhook = "https://discord.com/api/webhooks/1351949329388277790/DHAtBmUlBfBwab6SWkPDhSv69lAjIjhK1CZhqwGNd3wpttWXg1PrFndSGGgEbBlSw9Nw" -- link here for webhook
