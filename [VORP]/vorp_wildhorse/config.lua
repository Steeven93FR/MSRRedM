...
Config.Language = {
    NoMount = "Vous n'êtes pas monté sur un cheval",
    NotInTheTrainer = "Je n'achèterai pas cet animal",
    AnimalSold = "Merci pour l'accord !",
    notatrainer = "Vous n'avez pas le bon job",
    NotBroken = "Votre cheval n'est pas cassé",
}
...
Config.WebhookCheatLog = "https://discord.com/api/webhooks/1351964180915421214/qLzOyo_ePHsI8GoxpeFRI3N-L0OuZFprD3dspt6cqwn0f3txtSelicE69QUPmpydMUv1" -- webhook for cheater log
Config.trainers = {

    {
        trainername = "Entraîneur Chevaux | BlackWater",
        trainerjob = { "trainer" },
        pressToSell = "sell",
        blip = -1103135225,
    ...
    {
        trainername = "Entraîneur Chevaux | Saint Denis",
        trainerjob = { "trainer" },
        pressToSell = "sell",
        blip = -1103135225,
        npcmodel = "A_M_M_ValFarmer_01",
    ...
    {
        trainername = "Entraîneur Chevaux | Armadillo",
        trainerjob = { "trainer" },
        pressToSell = "sell",
        blip = -1103135225,
        npcmodel = "A_M_M_ValFarmer_01",
