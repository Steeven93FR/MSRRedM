...
ConfigShops.Locations = {
    {                                                   -- valentine
        Prompt = {
            ...
            Label = "Valentine Magasin | Vetements",                   -- prompt label
        },
        Npc = {
            Enable = true,
        ...
        Blip = {
            Enable = true,
            Sprite = 1195729388,
            Name = "Valentine Magasin | Vetements",
    ...
    {                                                     -- blackwater
        Prompt = {
            ...
            Label = "BlackWater Magasin | Vetements",                     -- prompt label
        },
        Npc = {
            Enable = true,
            Model = "CS_FRANCIS_SINCLAIR",
        ...
        Blip = {
            Enable = true,
            Sprite = 1195729388,
            Name = "BlackWater Magasin | Vetements",
            -- Color = 'BLIP_MODIFIER_MP_COLOR_23',
        },
        EditCharacter = { -- where the player will be teleported to edit character
        ...
        Prompt = {
            ...
            Label = "BlackWater Magasin | Style de Vie",                     -- prompt label
        },
        Npc = {
            Enable = true,
            Model = "CS_FRANCIS_SINCLAIR",
        ...
        Blip = {
            Enable = true,
            Sprite = 1195729388,
            Name = "BlackWater Magasin | Style de Vie",
            -- Color = 'BLIP_MODIFIER_MP_COLOR_23',
        },
        EditCharacter = { -- where the player will be teleported to edit character
    ...
    {                                                     -- Rhodes
        Prompt = {
            ...
            Label = "Ouvrir le Magasin de Vetements ?",               -- prompt label
        },
        Npc = {
            Enable = true,
            Model = "CS_FRANCIS_SINCLAIR",
    ...
    {                                                    -- Saint Denis
        ...
        Blip = {
            Enable = true,
            Sprite = 1195729388,
            Name = "Saint Denis Magasin | Vetements",
            -- Color = 'BLIP_MODIFIER_MP_COLOR_23',
        },
        EditCharacter = { -- where the player will be teleported to edit character
    ...
    {                                                      -- Strawberry
        ...
        Blip = {
            Enable = true,
            Sprite = 1195729388,
            Name = "Strawberry Magasin | Vetements",
            -- Color = 'BLIP_MODIFIER_MP_COLOR_23',
        },
        EditCharacter = { -- where the player will be teleported to edit character
    ...
    {                                                      -- Tumblweed
        ...
        Blip = {
            Enable = true,
            Sprite = 1195729388,
            Name = "Tumbleweed Magasin | Vetements",
            -- Color = 'BLIP_MODIFIER_MP_COLOR_23',
        },
        EditCharacter = { -- where the player will be teleported to edit character
    ...
    {                                                      -- Armadillo
        ...
        Blip = {
            Enable = true,
            Sprite = 1195729388,
            Name = "Armadillo Magasin | Vetements",
            -- Color = 'BLIP_MODIFIER_MP_COLOR_23',
        },
        EditCharacter = { -- where the player will be teleported to edit character
