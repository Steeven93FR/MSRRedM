...
Config.TownRestrictions = {
    ...
    { name = 'Armadillo',  mine_allowed = true },
    ...
    { name = 'Tumbleweed', mine_allowed = true },
    { name = 'Valentine',  mine_allowed = false },
    { name = 'Vanhorn',    mine_allowed = true },
}

-- Label name change manually for your language
Config.Items = {
    { name = "clay",       label = "Argile",         chance = 20, amount = 4 },
    { name = "coal",       label = "Charbon",         chance = 15, amount = 4 },
    { name = "copper",     label = "Cuivre",       chance = 10, amount = 8 },
    { name = "iron",       label = "Fer",         chance = 20, amount = 2 },
    { name = "nitrite",    label = "Nitrite",      chance = 8,  amount = 4 },
    { name = "rock",       label = "Pierre",        chance = 10, amount = 4 },
    { name = "salt",       label = "Sel",         chance = 10, amount = 4 },
    { name = "goldnugget", label = "pépite d'or", chance = 3,  amount = 2 },
}
