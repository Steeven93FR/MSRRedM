...
Config.Items = {
    ...
    { name = "wood",   label = "Bois Souple", chance = 10, amount = 2 },
    { name = "hwood",  label = "Bois Dûr", chance = 8,  amount = 2 },
    { name = "rubber", label = "Caoutchouc",    chance = 5,  amount = 4 },
    { name = "fibers", label = "Fibres",    chance = 8,  amount = 3 },
    { name = "pulp",   label = "Pulpe",      chance = 10, amount = 3 },
}
