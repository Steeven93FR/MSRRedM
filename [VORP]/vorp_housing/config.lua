...
Config.MyKey = "myHouseKey"      -- Command to get your house key if you lost it or give it to someones
...
Config.Rooms = {
    {
        Id        = 1,           -- Must be unique
        Name      = "Chambre | Chambre 2A",   -- Blip name 
...
Config.Houses = {
    {
        ...
        Name      = "Maison | Cabane Braithwaite", --blip name   
        Price     = 20000.0,
    ...
    {
        Id        = 104,
        Name      = "Maison | Rivière Lannahechee",
        Price     = 25000.0,
        key       = "hk_104",
    ...
    {
        Id        = 106,
        Name      = "Maison | Plaines de Southfield",
        Price     = 30000.0,
        key       = "hk_106",
    ...
    {
        Id        = 108,
        Name      = "Maison | Cabane de la vallée de Roanoke",
        Price     = 8000.0,
        key       = "hk_108",
    ...
    {
        Id        = 111,
        Name      = "Maison | Cabines dans la Neige",
        Price     = 15000.0,
        key       = "hk_111",
    ...
    {
        Id        = 113,
        Name      = "Maison | Cabine de Dakota Rivière",
        Price     = 20000.0,
        key       = "hk_113",
    ...
    {
        Id        = 114,
        Name      = "Maison | Maison de Dakota Rivière",
        Price     = 20000.0,
        key       = "hk_114",
    ...
    {
        Id        = 115,
        Name      = "Ferme | Ferme dans la Valée",
        Price     = 15000.0,
        key       = "hk_115",
    ...
    {
        Id        = 116,
        Name      = "Maison | Cabine d'Aurora Basin",
        Price     = 20000.0,
        key       = "hk_116",
        text      = vector3(-2590.92, 457.36, 147.41),
    ...
    {
        Id        = 117,
        Name      = "Maison | Maison de Little Creek River",
        Price     = 30000.0,
        key       = "hk_117",
    ...
    {
        Id        = 118,
        Name      = "Maison | Maison de Blackwater",
        Price     = 30000.0,
        key       = "hk_118",
    ...
    {
        Id        = 119,
        Name      = "Maison | Cabine de Little Creek River",
        Price     = 30000.0,
        key       = "hk_119",
    ...
    {
        Id        = 120,
        Name      = "Maison | Cabine de Cumberland Forest",
        Price     = 20000.0,
        key       = "hk_120",
    ...
    {
        Id        = 123,
        Name      = "Maison | Maison de Emerald station",
        Price     = 15000.0,
        key       = "hk_123",
    ...
    {
        Id        = 124,
        Name      = "Maison | Maison de Don Julio river",
        Price     = 30000.0,
        key       = "hk_124",
    ...
    {
        Id        = 125,
        Name      = "Maison | Maison de Cholla Springs",
        Price     = 25000.0,
        key       = "hk_125",
    ...
    {
        Id        = 126,
        Name      = "Maison | Maison au Nord de Tumbleweed",
        Price     = 25000.0,
        key       = "hk_126",
    ...
    {
        Id        = 127,
        Name      = "Maison | Cabine dans la Grande Valée",
        Price     = 15000.0,
        key       = "hk_127",
    ...
    {
        Id        = 128,
        Name      = "Maison | Cabane en cascade de Brandywine",
        Price     = 15000.0,
        key       = "hk_128",
    ...
    {
        Id        = 129,
        Name      = "Maison | Cabine de Eris Fields Forest",
        Price     = 10000.0,
        key       = "hk_129",
    ...
    {
        Id        = 130,
        Name      = "Maison | Maison de Cumberland Waterfall",
        Price     = 30000.0,
        key       = "hk_130",
    ...
    {
        Id        = 131,
        Name      = "Manoir | Manoir Braithwaite",
        Price     = 80000.0,
        key       = "hk_131",
