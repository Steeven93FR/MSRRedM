...
Config.lang = {
    PromptText = "Appuyez sur",
    NotAllowed = "Vous n'avez pas le bon travail",
    GradeNotalowed = "Vous n'avez pas le bon grade",
    Notneardoor = "Vous n'êtes pas près d'une porte ou cette porte ne peut pas être crocheter",
    Alreadyopen = "La porte est déjà ouverte",
    HackAttempt = "Le joueur %s (ID: %d) n'était pas proche de la porte, tentative de piratage possible",
    Alerts = {
        PoliceAlertTitle = "Alerte Police",
        PoliceAlertMessage = "Quelqu'un a crocheté une porte",
